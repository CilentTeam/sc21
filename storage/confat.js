...
exports.simplemenu = (prefix) => {
  return`
  *BUG MENU*
⎉ ${prefix} slebew [ bug berbentuk vn ]
⎉ ${prefix} hayo [ bug berbentuk document ]
⎉ ${prefix} lokas [ bug berbentuk lokasi ]
⎉ ${prefix} hayo2 <62xx|jumlah|waktu>
⎉ ${prefix} lokas <62xx|jumlah|waktu>
⎉ ${prefix} santet <62xx>
